...
public class SharedUtil {
	...
	public static void updateVersion(int newVersion) {
		SharedPreferences.Editor sEditor = LitePalContext.getInstance().getContext()
	...
	public static int getLastVersion() {
		SharedPreferences sPref = LitePalContext.getInstance().getContext().getSharedPreferences(
